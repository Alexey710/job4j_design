...
public class PrepareStatementDemo {
    ...
    public void initConnection() throws Exception {
        ...
        String url = "jdbc:postgresql://localhost:5432/dml";
    ...
    public static void main(String[] args) throws Exception {
        City city = new City(1, "Moscow", 14000000);
        City city1 = new City(1, "Kazan", 14000000);
        PrepareStatementDemo psd = new PrepareStatementDemo();
        psd.insert(city);
        psd.update(city1);
        psd.delete(1);
        for (City elem : psd.findAll()) {
